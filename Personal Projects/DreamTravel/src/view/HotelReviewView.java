...
public class HotelReviewView {
    ...
    private JLabel titleLabel = new JLabel("Hotel Reviews");
    ...
    public JPanel createReviewPanel(String hotelName, String reviewText, String username, ImageIcon userPhoto) {
