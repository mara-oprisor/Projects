...
public class LogInView {
    ...
    private JLabel labelTitle = new JLabel("LogIn Form");
    private ImageIcon icon = new ImageIcon("src/images/icons8-log-in-64.png");
    ...
    private JComboBox<String> dropDownType = new JComboBox<>(new String[]{"Client", "Admin"});
    ...
    public void showMessage(String message, int option) {
        if (option == 0) {
            JOptionPane.showMessageDialog(frame, message, "LogIn Message", JOptionPane.ERROR_MESSAGE);
        }
        if (option == 1) {
            JOptionPane.showMessageDialog(frame, message, "LogIn Message", JOptionPane.INFORMATION_MESSAGE);
        }
    }
}
